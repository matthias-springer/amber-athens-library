define("amber-athens/Athens-HTML-Tutorial", ["amber/boot", "amber_core/Kernel-Objects", "amber/web/Web"], function($boot){"use strict";
var $core=$boot.api,nil=$boot.nil,$recv=$boot.asReceiver,$globals=$boot.globals;
$core.addPackage('Athens-HTML-Tutorial');
$core.packages["Athens-HTML-Tutorial"].innerEval = function (expr) { return eval(expr); };
$core.packages["Athens-HTML-Tutorial"].transport = {"type":"amd","amdNamespace":"amber-athens"};
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: ["surface"],
source: "prepareFor: surface\x0a\x09fill ifTrue: [\x0a\x09\x09fillPaint := surface createSolidColorPaint: fillPaint.\x0a\x09].\x0a\x0a\x09stroke ifTrue: [\x0a\x09\x09strokePaint := \x0a\x09\x09\x09surface createStrokePaintFor: (surface createSolidColorPaint: strokePaint).\x0a\x09].",
referencedClasses: [],
//>>excludeEnd("ide");
...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
html=$recv($HTMLCanvas())._onJQuery_("body"._asJQuery());
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "open\x0a\x09|html|\x0a\x09html := HTMLCanvas onJQuery: 'body' asJQuery.\x0a\x09html with: AthensTutorialWidget new.",
...
$recv($AthensTutorial())._compile_protocol_("doIt".__comma($recv($recv(self["@codeArea"])._asJQuery())._val()),"tutorial");
...
//>>excludeStart("ide", pragmas.excludeIdeData);
args: [],
source: "stepDoIt\x0a\x09|selector|\x0a\x09selector := ('doItstep', step asString) asSymbol.\x0a\x09AthensTutorial compile: 'doIt', codeArea asJQuery val protocol: 'tutorial'.\x0a\x09tutorial perform: selector.\x0a\x09AthensTutorial removeCompiledMethod: (AthensTutorial methodAt: selector)",
referencedClasses: ["AthensTutorial"],
//>>excludeEnd("ide");
messageSends: ["asSymbol", ",", "asString", "compile:protocol:", "val", "asJQuery", "perform:", "removeCompiledMethod:", "methodAt:"]
}),
$globals.AthensTutorialWidget);
...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $2,$1,$3,$4,$6,$7,$5,$9,$10,$8,$12,$13,$11,$15,$16,$14,$18,$19,$17,$20,$21,$22,$23,$25,$27,$26,$24,$29,$31,$30,$28,$33,$35,$34,$32,$37,$39,$38,$36,$40,$41,$42,$43,$44,$46,$47,$48,$45,$49,$51,$52,$53,$50,$54,$55;
...
return $core.withContext(function($ctx2) {
//>>excludeEnd("ctx");
self._assert_($recv($recv(ea)._fillRule()).__eq("VGNONZERO"));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
self._assert_($recv(ptStream)._atEnd());
$55=paths;
return $55;
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
return $core.withContext(function($ctx1) {
//>>excludeEnd("ctx");
var $1,$3,$2,$5,$4,$6,$7,$8,$9,$12,$16,$15,$14,$13,$11,$10,$17,$18,$19,$22,$21,$20,$25,$24,$23,$27,$30,$29,$28,$26;
...
zoom=$recv($4)._abs();
zoom;
return $recv(self["@surface"])._drawDuring_((function(can){
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
return $core.withContext(function($ctx3) {
//>>excludeEnd("ctx");
$6=$recv(can)._pathTransform();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["pathTransform"]=1;
//>>excludeEnd("ctx");
$recv($6)._loadIdentity();
$recv(can)._setPaint_($recv($Color())._white());
$7=$recv(can)._drawShape_($recv((0).__at((0)))._corner_($recv(self["@surface"])._extent()));
$7;
$8=$recv(can)._pathTransform();
$9=$8;
$12=$recv(extent)._x();
$16=self._class();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
$15=$recv($16)._tigerMaxX();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["tigerMaxX"]=1;
//>>excludeEnd("ctx");
$14=$recv($15).__star(scale);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=3;
//>>excludeEnd("ctx");
$13=$recv($14).__star(zoom);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=2;
//>>excludeEnd("ctx");
$11=$recv($12).__minus($13);
$10=(0.5).__star($11);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=1;
//>>excludeEnd("ctx");
$recv($9)._translateByX_Y_($10,$recv($recv(extent)._y()).__slash((-12)));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["translateByX:Y:"]=1;
//>>excludeEnd("ctx");
$17=$8;
$18=$recv(scale).__star(zoom);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=4;
//>>excludeEnd("ctx");
$recv($17)._scaleBy_($18);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["scaleBy:"]=1;
//>>excludeEnd("ctx");
$19=$8;
$22=self._class();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
...
//>>excludeEnd("ctx");
$21=$recv($22)._tigerMaxX();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["tigerMaxX"]=2;
//>>excludeEnd("ctx");
$20=$recv($21).__star((0.5));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=5;
//>>excludeEnd("ctx");
$25=self._class();
...
//>>excludeEnd("ctx");
$24=$recv($25)._tigerMaxY();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["tigerMaxY"]=2;
//>>excludeEnd("ctx");
$23=$recv($24).__star((0.5));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=6;
//>>excludeEnd("ctx");
$recv($19)._translateByX_Y_($20,$23);
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["translateByX:Y:"]=2;
//>>excludeEnd("ctx");
$recv($8)._scaleBy_((0.8));
$recv($8)._rotateByDegrees_(rotation);
$27=$8;
$30=self._class();
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["class"]=5;
//>>excludeEnd("ctx");
$29=$recv($30)._tigerMaxX();
$28=$recv($29).__star((-0.5));
//>>excludeStart("ctx", pragmas.excludeDebugContexts);
$ctx3.sendIdx["*"]=7;
//>>excludeEnd("ctx");
$26=$recv($27)._translateByX_Y_($28,$recv($recv(self._class())._tigerMaxY()).__star((-0.5)));
$26;
